...
# File to source into iPython for interacive console use
#
...
from pytuning.number_theory import *
from pytuning.constants import *
from pytuning.scales import *
from pytuning.metrics import *
from pytuning.tuning_tables import *
from pytuning.scale_creation import find_best_modes, create_scale_from_scale, find_factors
...
scale = []         # Current Scale
cents = []         # Cent values of current scale
distinct_i = []    # Distinct intervals
generators = []    # Linear temprement generators
